...
<li class="task" id="<?= 'task_'.$model->id; ?>" data-ajax-url-move="<?= Url::to(['task/move', 'id'=>$model->id]) ?>" data-ajax-receive-url="<?= Url::to(['task/receive', 'id'=>$model->id]) ?>"  data-ajax-url-view="<?= Url::to(['task/view', 'id'=>$model->id]) ?>" onclick="return viewTask(this);">
    <div class="list-card-details">
        <div class="list-card-labels js-card-labels">
            <?php
            $select_labels=TaskLabel::find()->active()->findByTask($model->id)->all();
            echo $this->render('/project/_label_list', [
        ...
        <div class="list-card-members">
            ...
            echo $this->render('/project/_member_list', [
