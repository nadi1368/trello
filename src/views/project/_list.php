...
<div class="list" id="list-new">
    <div class="list-new">
        <a href="#" id="add-new-list"  data-type="text" data-pk="<?= $project->id; ?>" data-url="<?= Url::to(['project-status/create']); ?>"   data-placement="right" data-title="<?= Yii::t("app","Enter New Project Status Title") ?>"></a>
    </div>
</div>