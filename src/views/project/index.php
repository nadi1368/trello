...
?>
    <div class="ui <?= Html::encode($project->color); ?>" id="<?= 'main-board-'.$project->id ?>" data-color="<?= Html::encode($project->color); ?>">
        <nav class="navbar app">
            ...
            <li>
                <a href="#" class="icon-list" onclick="return showPopOverTeam(this);" data-pop-id="#pop-menu-menu" title="<?= Yii::t("app","Show Menu") ?>"><i class="fa fa-align-justify" data-pop-id="#pop-menu-menu"></i> </a>
            </li>
            <li>
                <a href="#" class="icon-list" onclick="return showPopOverTeam(this);" data-pop-id="#pop-menu-team" title="<?= Yii::t("app","Create New Team") ?>"><i class="fa fa-plus" data-pop-id="#pop-menu-team"></i> </a>
            </li>
        </nav>
