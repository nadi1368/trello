...
<div class="pop-over-header js-pop-over-header">
    <span class="pop-over-header-title"><?= Module::t("module","Teams") ?></span>
...
<div class="pop-over-content"  id="project-team-list">
    <div class="list-group without-border  rtl">
                ...
                <tr>
                    <td width="20px">
                        <?php if($project->isAdmin($user_id)): ?>
                            <a href="#" class="delete" data-ajax-url="<?= Url::to(['project/remove-team', 'id'=>$project->id, 'project_team'=>$team->id]) ?>" title="<?= Module::t("module","Delete This Team") ?>"  onclick="return teamProject(this);">
                    ...
                    <td width="20px">
                        <a href="<?= Url::to(['teams/index', 'id'=>$team->team->id, 'project_id'=>$project->id]) ?>"  title="<?= Module::t("module","View This Team") ?>" >
                            <i class="fa fa-eye"></i>
                        </a>
                    </td>
                </tr>
        ...
        <hr />
        <input type="tex" id="search-project-team-input" data-ajax-url="<?= Url::to(['project/search-team', 'id'=>$project->id]) ?>" class="form-control rtl" placeholder="<?= Module::t("module","Search Team") ?>">
